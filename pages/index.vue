...
<template>
  <main>
    <!-- Hero section -->
    <section class="tw-flex tw-flex-col tw-bg-gradient-to-b tw-from-background tw-to-slate-800">
      <div class="tw-w-full tw-h-[30rem] tw-flex tw-flex-col tw-items-center tw-justify-center">
        <h1 class="tw-font-heading tw-text-[4.2rem] tw-font-bold dark:tw-text-text-color tw-mb-5">
          Write your own Ethiopian narrative
        </h1>
        <p class="tw-font-body tw-text-2xl dark:tw-text-text-color tw-mb-20">
        ...
        <v-btn
          ...
          <span>Explore</span>
          <font-awesome-icon class="tw-w-5 tw-h-5 dark:hover:tw-text-primary tw-ml-4"
    ...
    <!-- Below the fold -->
    <!-- Article section -->
    <section class="tw-flex tw-flex-col tw-items-center tw-gap-40 tw-mt-28">
      <trending-articles-row />

      <div
        class="tw-w-full tw-relative tw-flex tw-flex-col tw-gap-40 tw-bg-gradient-to-b tw-from-background tw-to-slate-800">
        <topics-carousel-row />
    ...
    <!-- Fiction section -->
    <section class="tw-flex tw-flex-col tw-items-center tw-gap-40 tw-mt-16 tw-mb-16">
