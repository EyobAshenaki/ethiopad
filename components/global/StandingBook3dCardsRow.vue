...
const props = defineProps<{ rowTitle: string }>();
...
<template>
  ...
  >
    <h2 v-if="!!rowTitle" class="tw-font-heading tw-font-semibold tw-text-3xl">
      {{ rowTitle }}
    </h2>
...
<style scoped>
.collection {
  @apply tw-w-max tw-flex tw-flex-wrap -tw-space-x-10;
